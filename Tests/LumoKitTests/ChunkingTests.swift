...
func testLumoKitPublicAPI() async throws {
    ...
    #expect(chunks.count == chunksWithMetadata.count, "Should have same number of chunks")
    #expect(chunks.first == chunksWithMetadata.first?.text, "Text content should match")
